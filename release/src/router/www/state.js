...
function show_banner(L3){// L3 = The third Level of Menu
	...
	banner_code +='<span onclick="change_wl_unit_status(1)" id="elliptic_ssid_5g" class="title_link"></span><div style="display:inline;float:right;font-size:10px;">(Merlin LTS fork, Tenda edition)</div>\n';
	banner_code +='</td>\n';
