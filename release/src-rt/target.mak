...
export RT-AC68U := IPV6SUPP=y HTTPS=y ARM=y BCM57=y NTFS=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y \
                   SAMBA3=y SAMBA36=y MEDIASRV=y MODEM=n MODEMPIN=n BECEEM=n PARENTAL2=n ACCEL_PPTPD=y PRINTER=y \
                   ...
                   BTN_WIFITOG=y TURBO=y BCM4352_5G=y OPTIMIZE_XBOX=n USBEJECT=y ODMPID=y LED_BTN=y \
                   LED_BTN_MODE=y BCMSMP=y XHCI=y USBRESET=n SSH=y JFFS2=y NFS=n OPENVPN=y USER_LOW_RSSI=y \
                   TIMEMACHINE=n MDNS=y VPNC=y BRCM_NAND_JFFS2=y JFFS2LOG=y DUMP_OOPS_MSG=y BCMFA=y XHCIMODE=y BWDPI=n \
                   IPSEC=y REPEATER=y DUALWAN=y YANDEXDNS=n DNSFILTER=y REBOOT_SCHEDULE=y LINUX_MTD="64" TEMPROOTFS=y \
                   DEBUGFS=n TFAT=n HFS="none" NTFS="paragon" DNSSEC=y DNSCRYPT=n STUBBY=y NANO=n USBHID=n DPSTA=y SPI=y
